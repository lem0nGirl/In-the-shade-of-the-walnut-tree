...
define config.name = _("In the Shade of the Walnut Tree")
...
define build.name = "IntheShadeoftheWalnutTree"
...
define config.save_directory = "IntheShadeoftheWalnutTree-1741772136"
